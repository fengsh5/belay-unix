...
const basicCode = `<template>
  <view>
    <bl-picker-selector></bl-picker-selector>
  </view>
<\/template>`

const disabledCode = `<template>
  <view>
    <bl-picker-selector disabled>禁用状态</bl-picker-selector>
  </view>
<\/template>`
</script>
...
`uni_modules/belay-unix/components/bl-picker-selector/README.md`
