...
const basicCode = `<template>
  <view>
    <bl-float-button></bl-float-button>
  </view>
<\/template>`

const disabledCode = `<template>
  <view>
    <bl-float-button disabled>禁用状态</bl-float-button>
  </view>
<\/template>`

const eventCode = `<template>
  <view>
    <bl-float-button @click="handleClick">点击我</bl-float-button>
  </view>
<\/template>
...
`uni_modules/belay-unix/components/bl-float-button/README.md`
